...
- [Packaging / Release-Paket](./packaging/README.md)
...
Das Packaging beschreibt, wie Mini EMS als versioniertes Release-Paket (PyInstaller, später Nuitka-kompatibel)
statt als Git-Checkout ausgeliefert wird (H2); der Betriebspfad bleibt externes `config.json` plus Windows-Task.
