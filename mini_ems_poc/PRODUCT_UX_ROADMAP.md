...
aktiv bearbeitet wird, ist UX12 damit ebenfalls kein aktueller Umsetzungsschritt; die aktive Linie ist
stattdessen `ROADMAP.md` S13-S15 (professioneller Write-Back und Anlagen-Safety, Branch
`codex/s13-s15-writeback-safety`), das aktuell keinen eigenen UX-Punkt auslöst.
