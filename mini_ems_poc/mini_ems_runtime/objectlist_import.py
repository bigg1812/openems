...
SELECTED_REPORT_POINTS: Dict[str, ObjectListReportPoint] = {
    ...
    "AI1107": ObjectListReportPoint("site.heat_generation_flow_temperature_c", "AI", 1107, "Wärmeerzeugung Vorlauf", "C", -20.0, 120.0),
    "AI1108": ObjectListReportPoint("site.heat_generation_return_temperature_c", "AI", 1108, "Wärmeerzeugung Rücklauf", "C", -20.0, 120.0),
    "AI1201": ObjectListReportPoint("site.boiler_1_return_temperature_c", "AI", 1201, "Gaskessel Rücklauf", "C", -20.0, 120.0),
    "AI1202": ObjectListReportPoint("site.boiler_2_return_temperature_c", "AI", 1202, "Pelletkessel Rücklauf", "C", -20.0, 120.0),
    "AI1203": ObjectListReportPoint("site.chp_flow_temperature_c", "AI", 1203, "BHKW Vorlauf", "C", -20.0, 120.0),
    "AI1204": ObjectListReportPoint("site.chp_return_temperature_c", "AI", 1204, "BHKW Rücklauf", "C", -20.0, 120.0),
